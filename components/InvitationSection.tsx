    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-4 md:px-6">
                ...
                >
                    <div className="w-full relative bg-brand-stone">
                        {/* Darkened overlay when not playing (initially or paused) */}
                        <div className={`absolute inset-0 z-10 bg-brand-stone/60 transition-opacity duration-700 pointer-events-none ${isPlaying ? "opacity-0" : "opacity-100"}`}></div>

                        <video
                            src="/videoboda.mp4"
                            controls={isPlaying}
                            className="w-full h-auto min-h-[300px] md:min-h-[500px] max-h-[85dvh] block object-contain"
                        ...
                        {/* Play Overlay - Always visible when paused */}
                        {!isPlaying && (
                            <div
