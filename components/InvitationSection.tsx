    ...
    return (
        <section id="invitacion" ref={sectionRef} className="py-20 bg-brand-beige border-t border-brand-gold/10 overflow-hidden relative">
            <div className="max-w-7xl mx-auto px-4 md:px-6">
                ...
                <div className={`relative rounded-2xl overflow-hidden shadow-2xl shadow-brand-gold/10 transition-all duration-1000 delay-200 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
