...
const FORM_CONFIG = {
  RSVP: {
    ...
    actionUrl: "https://docs.google.com/forms/d/e/1FAIpQLScPKMFOnwLPChgOx_x2Ug0-mpIpjm0a_77uag4o-NYMopoXSw/formResponse",
    fields: {
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <label className="cursor-pointer relative flex items-center gap-4 p-4 rounded-lg border border-brand-gold/20 hover:border-brand-gold bg-white transition-all group">
                    <input type="radio" name={FORM_CONFIG.RSVP.fields.attendance} value="Asistiré con gusto" className="w-5 h-5 text-brand-gold bg-transparent border-gray-400 focus:ring-brand-gold" defaultChecked />
                    <div>
                  ...
                  <label className="cursor-pointer relative flex items-center gap-4 p-4 rounded-lg border border-brand-gold/20 hover:border-red-400 bg-white transition-all group">
                    <input type="radio" name={FORM_CONFIG.RSVP.fields.attendance} value="Tristemente no" className="w-5 h-5 text-red-500 bg-transparent border-gray-400 focus:ring-red-500" />
                    <div>
